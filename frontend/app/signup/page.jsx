...
import { FiUser, FiMail, FiLock, FiArrowRight, FiCompass } from "react-icons/fi";
        ...
        try {
            ...
            if (res.ok) {
                ...
                if (loginRes.ok) {
                    ...
                    setWarning("Signup successful, but auto-login failed.");
                }
            } else {
                setWarning(data?.error || "Signup failed");
            }
        } catch (err) {
        ...
        <div className="min-h-screen flex items-center justify-center p-4 relative">
            ...
            <div className="w-full max-w-md relative z-10">
                <div className="text-center mb-8">
                    ...
                    <p className="text-[#8888a8] mt-1 text-sm">Start your nutrition journey today</p>
                </div>

                <div className="glass-card p-8">
                    <form onSubmit={handleSubmit} className="space-y-4 mb-4">
                        <div>
                            <label className="block text-xs font-medium text-[#8888a8] mb-2">Name</label>
                            <div className="relative">
                                <FiUser size={15} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[#555570]" />
                                <input
                                    type="text"
                                    name="name"
